...
### Критерий силы (все три)

1. **Сцена** — конкретный человек в конкретный момент.
...
8. Мельница детекторов: серии правок / path / fingerprint / «источник × метрика» / коллизия графа без ритуала на 30 секунд.
9. Платёжный тест провален.
10. Клон сюжета из последних ~30 номеров `PROPOSED`.

Уроки: **114, 115, 117, 118**; **269–273**; **285/286/288**; радары **274–313**.
...
- Меняет ритуал за ~1 минуту в B24.
- Не сводится к уведомлению робота или фильтру «как есть».
